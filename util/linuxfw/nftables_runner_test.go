...
func TestAddMatchSubnetRouteMarkRuleMasq(t *testing.T) {
	...
	want := [][]byte{
		...
		// nft add rule ip ts-nat-test ts-postrouting-test meta mark & 0x0000f000 == 0x00001000 counter masquerade
		[]byte(""),
		// batch end
		[]byte("\x00\x00\x00\x0a"),
	}
	testConn := newTestConn(t, want, nil)
...
func TestAddMatchSubnetRouteMarkRuleAccept(t *testing.T) {
	...
	want := [][]byte{
		...
		// nft add chain ip ts-filter-test ts-forward-test { type filter hook forward priority 0\; }
		[]byte(""),
		// nft add rule ip ts-filter-test ts-forward-test meta mark and 0x0000f000 eq 0x00001000 counter accept
		[]byte(""),
		// batch end
		[]byte("\x00\x00\x00\x0a"),
	}
	testConn := newTestConn(t, want, nil)
...
func TestMakeConnmarkSaveExprs(t *testing.T) {
	...
	want := [][]byte{
		...
		// nft add rule ip mangle OUTPUT ct state new meta mark & 0xf000 != 0 ct mark set meta mark & 0xf000
		[]byte(""),
		// batch end
		[]byte("\x00\x00\x00\x0a"),
	}
